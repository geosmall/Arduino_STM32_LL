...
#define UVOS_MPU9250_CONFIG_MAP_FILTERSETTING(x) \
  (x == IMUGYROACCELSETTINGS_FILTERSETTING_LOWPASS_188_HZ ? UVOS_MPU9250_LOWPASS_188_HZ : \
   x == IMUGYROACCELSETTINGS_FILTERSETTING_LOWPASS_98_HZ ? UVOS_MPU9250_LOWPASS_98_HZ : \
   x == IMUGYROACCELSETTINGS_FILTERSETTING_LOWPASS_42_HZ ? UVOS_MPU9250_LOWPASS_42_HZ : \
   x == IMUGYROACCELSETTINGS_FILTERSETTING_LOWPASS_20_HZ ? UVOS_MPU9250_LOWPASS_20_HZ : \
   x == IMUGYROACCELSETTINGS_FILTERSETTING_LOWPASS_10_HZ ? UVOS_MPU9250_LOWPASS_10_HZ : \
   x == IMUGYROACCELSETTINGS_FILTERSETTING_LOWPASS_5_HZ ? UVOS_MPU9250_LOWPASS_5_HZ : \
