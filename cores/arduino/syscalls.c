...
__attribute__((weak))
int _open( UNUSED(const char * name), UNUSED(int flags), UNUSED(int mode) )
{
  return -1;
}

__attribute__((weak))
int _gettimeofday( UNUSED(struct timeval * tv), UNUSED(void * tzvp) )
{
  return -1;
}

__attribute__((weak))
clock_t _times( UNUSED(struct tms * tms) )
{
  return -1;
}

__attribute__((weak))
int _link( UNUSED(const char * oldpath), UNUSED(const char * newpath) )
{
  return -1;
}

__attribute__((weak))
int _unlink( UNUSED(const char * pathname) )
{
  return -1;
}
